...
Task<int> elidable() {
  ...
  // CHECK: call void @_Z6calleev(ptr dead_on_unwind writable sret(%struct.Task) align 8 %[[TASK_OBJ]]) #[[MUST_ELIDE:.+]]
...
// CHECK: attributes #[[MUST_ELIDE]] = { coro_must_elide }
